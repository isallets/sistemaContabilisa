...
// Servir frontend (index.html, style.css, script.js) da raiz
...
// --- Função para criar contas padrão se o banco estiver vazio ---
const criarContasPadrao = async () => {
  ...
  if (!snapshot.exists()) {
    ...
    console.log("Contas padrão criadas no Firebase!");
  }
};
...
// Aqui você mantém exatamente a lógica que tinha, só lendo do Firebase
// Balancete
